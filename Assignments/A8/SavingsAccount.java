...
public class SavingsAccount extends BankAccount {
    ...
    private static double annualInterestRate; // Represented as a percent - always positive.
    ...
    public double getMonthlyFeesAndInterest() {
        ...
        if (this.getBalance() < 1000.0) {
            ...
            double monthlyInterest = ((SavingsAccount.annualInterestRate / 100) * (this.getBalance())) / 12.0;
